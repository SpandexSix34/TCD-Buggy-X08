...
void setup() {
  client = new Client(this, "10.111.64.172", 3000);
  ...
  Button Self = p5.addButton("Self").setPosition(30, 330).setSize(170, 50).setLabel("Self"); // New button for combined mode
  ...
  Self.setFont(Font1); // Set font for the new button
  ...
  Self.setColorBackground(color(26, 36, 201))   
         .setColorForeground(color(110, 117, 242))  
         .setColorActive(color(110, 117, 242))      
         .setColorCaptionLabel(color(255));
